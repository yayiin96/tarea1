...
Para la construcción de la estructura cristalina del Xenón (Xe) \cite{}, también es necesario considerar 
...
Para las interacciones de los átomos se ocupó el potencial de Lennard-Jones mediante la 
extensión $lennardjones$.
...
[1] Eni Generalic Faculty Of Chemistry Croatia and Split Technology. Helio
- ENIG. Tabla Periódica de los elementos. url: https://www.periodni.
com/es/he.html.

[2] Charles Kittle. lntroduction to Solid State Physic. 8th ed.

[3] “Modified Lennard-Jones Potentials with a Reduced Temperature-Correction
Parameter for Calculating Thermodynamic and Transport Properties: Noble 
Gases and Their Mixtures (He, Ne, Ar, Kr, and Xe)”. In: 2013 ().

[4] Las Palmeras Molecular Dynamics. url: https://www.lpmd.cl/.
